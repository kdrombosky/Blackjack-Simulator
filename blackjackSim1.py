...
def sim1(moneyPot=1000, rounds=0, highestPot=1000):
    rounds += 1
    ...
    if total > 21:
        ...
        moneyPot -= bet
        sim1(moneyPot, rounds, highestPot)
    while 1:
        if total < 16:
            newCard = hit()
...
print("Black Jack Simulation 1: ")
print("Always hit when your hand is less than 16/Straight Betting")
highestPot = 1000
makeDeck()
sim1()
