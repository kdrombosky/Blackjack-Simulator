...
def sim4(moneyPot=1000, rounds=0, highestPot=1000, win=True):
    rounds += 1
    ...
    if total > 21:
        ...
        moneyPot -= bet
        sim4(moneyPot, rounds, highestPot, win=False)
    while 1:
        face = False
        for card in yourCards:
        ...
        if not face:
            ...
            simStay(yourCards, dealersCards,
                    moneyPot, bet, rounds, highestPot)
...
def simStay(yourCards, dealersCards, moneyPot, bet, rounds, highestPot):
    ...
    while dealerTotal < 21:
        ...
        if dealerTotal > 21:
            print("You win!")
            moneyPot += bet
            sim4(moneyPot, rounds, highestPot, win=True)
...
print("Black Jack Simulation 4: ")
print("Always stay when you have a face card/Oscar's Grind Betting")
highestPot = 1000
makeDeck()
sim4()
